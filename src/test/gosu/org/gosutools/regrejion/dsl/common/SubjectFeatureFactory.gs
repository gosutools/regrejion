 ...
 */
package org.gosutools.regrejion.dsl.common
...
class SubjectFeatureFactory {
    static function createDegenerateSubjectFeatureSpy(name: String,
                                                      purpose: String,
                                                      singleScenario: BuiltScenario) : BuiltFeature {
      return Feature.named(name)
          .withPurpose(purpose)
          .withNoStepsRunOnceBeforeFirstScenario()
          .withNoStepsRunBeforeEachScenario()
          .withScenario(singleScenario)
          .withNoMoreScenarios()
